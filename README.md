...
## Methodology
- **Hazard Data:** Coastal flood inundation maps from [**WRI Aqueduct**](https://wri-projects.s3.amazonaws.com/AqueductFloodTool/download/v2/index.html) (1-in-100 year return period). 
